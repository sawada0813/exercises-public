...
class MandelbrotCanvas {
  constructor(canvas) {
    ...
    this.state = PageState.fromURL(window.location) || PageState.initState();
  ...
  handleKey(event) {
    switch (event.key) {
      case "Escape":
        this.setState(PageState.initState());
        break;
      case "+":
        this.setState((s) => {
